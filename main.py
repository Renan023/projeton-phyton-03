...
[7] 7 vezes - OBS:. até R$ 3.000.00\n[8] 8 vezes\n[9] 9 vezes\n[10] 10 vezes - OBS:. de R$ 5.500.00 """)
    ...
    if op == 0:desconto(v, 90, 100)
    elif op == 1:desconto(v, 95, 100)
    elif op == 2:acrescimoparcelado(v, 100, 100, 2)
    elif op == 3:acrescimoparcelado(v, 110, 100, 3)
    elif op == 4:acrescimoparcelado( v , 115, 100, 4)
    elif op == 5 and v >= 1500.00:acrescimoparcelado(v, 120, 100, 5)
    elif op == 6:acrescimoparcelado(v, 125, 100, 6)
    elif op == 7 and v >= 3000.00:acrescimoparcelado(v, 130, 100, 7)
    elif op == 8:acrescimoparcelado(v, 135, 100, 8)
    elif op == 9:acrescimoparcelado(v, 140, 100, 9)
    elif op == 10 and v >= 5500.00:acrescimoparcelado(v, 145, 100, 10)
    else:
